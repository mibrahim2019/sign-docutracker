...
<p align="center" style="margin-top: 20px">
  ...
  <br>
    <a href="https://docutracker.io"><strong>Learn more »</strong></a>
    <br />
    <br />
...
Signing documents digitally should be fast and easy and should be the best practice for every document signed worldwide. This is technically quite easy today, but it also introduces a new party to every signature: The signing tool providers. While this is not a problem in itself, it should make us think about how we want these providers of trust to work. Docutracker aims to be the world's most trusted document-signing tool. This trust is built by empowering you to self-host Docutracker and review how it works under the hood.
...
To run Docutracker locally, you will need
...
Follow these steps to setup Docutracker on your local machine:
...
If you're a visual learner and prefer to watch a video walkthrough of setting up Docutracker locally, check out this video:
...
> If you are using a reverse proxy in front of Docutracker, don't forget to provide the public URL for the `NEXT_PUBLIC_WEBAPP_URL` variable!
