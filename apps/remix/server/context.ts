...
import { extractSessionCookieFromHeaders } from '@docutracker/auth/server/lib/session/session-cookies';
import {
  type RequestMetadata,
  extractRequestMetadata,
} from '@docutracker/lib/universal/extract-request-metadata';
