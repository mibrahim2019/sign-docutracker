...
import type { GetUserWithDocumentMonthlyGrowth } from '@docutracker/lib/server-only/admin/get-users-stats';
...
const CustomTooltip = ({
  ...
  if (active && payload && payload.length) {
    return (
      <div className="z-100 w-60 space-y-1 rounded-md border border-solid bg-popover p-2 px-3 text-popover-foreground">
        <p className="">{label}</p>
