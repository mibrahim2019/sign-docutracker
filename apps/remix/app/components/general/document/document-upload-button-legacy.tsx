...
import type { TCreateDocumentPayloadSchema } from '@docutracker/trpc/server/document-router/create-document.types';
import type { TCreateTemplatePayloadSchema } from '@docutracker/trpc/server/template-router/schema';
import { cn } from '@docutracker/ui/lib/utils';
import { DocumentUploadButton as DocumentUploadButtonPrimitive } from '@docutracker/ui/primitives/document-upload-button';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
