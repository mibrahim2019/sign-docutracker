...
import { RECIPIENT_COLOR_STYLES } from '@docutracker/ui/lib/recipient-colors';
  ...
  return (
    <>
      ...
      {selectedField && (
        <div
          className={cn(
            'pointer-events-none fixed z-50 flex cursor-pointer flex-col items-center justify-center rounded-[2px] bg-white font-noto text-muted-foreground ring-2 transition duration-200 [container-type:size]',
