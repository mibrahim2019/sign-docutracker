...
import { SUPPORT_EMAIL } from '@docutracker/lib/constants/app';
  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Docutracker to perform your electronic document signing. The purpose
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Docutracker, you
