---
title: Manual Setup
description: Manually set up Docutracker on your machine for local development.
---
...
Follow these steps to set up Docutracker on your local machine:

<Steps>

### Fork Docutracker

Fork the [Docutracker repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
npm run prisma:seed -w @docutracker/prisma
```
