...
Our embedding feature lets you integrate our document signing experience into your own application or website. Whether you're building with React, Preact, Vue, Svelte, Solid, Angular, or using generalized web components, this guide will help you get started with embedding Docutracker.

## Embedded Signing vs Embedded Authoring

Embedded signing allows you to embed your Docutracker documents into your application for signing. Your users will be able to sign the document directly in your application.

Embedded authoring allows you to integrate Docutracker's document and template creation and editing into your application. You will be able to create and edit documents and templates directly in your application.
...
- Dark mode controls
- The removal of Docutracker branding from the embedding experience

## How Embedding Works

Embedding with Docutracker allows you to handle document signing in two main ways:

1. **Using Direct Templates**: Using direct templates you can have an evergreen template that upon completion will create a new document within Docutracker.
2. **Using a Signing Token**: A more advanced option for those running rich integrations with Docutracker already. Given a recipients signing token you can embed the signing experience in your application rather than direct the recipient to Docutracker.
...
| Framework | Package                                                                                |
| --------- | -------------------------------------------------------------------------------------- |
| React     | [@docutracker/embed-react](https://www.npmjs.com/package/@docutracker/embed-react)     |
| Preact    | [@docutracker/embed-preact](https://www.npmjs.com/package/@docutracker/embed-preact)   |
| Vue       | [@docutracker/embed-vue](https://www.npmjs.com/package/@docutracker/embed-vue)         |
| Svelte    | [@docutracker/embed-svelte](https://www.npmjs.com/package/@docutracker/embed-svelte)   |
| Solid     | [@docutracker/embed-solid](https://www.npmjs.com/package/@docutracker/embed-solid)     |
| Angular   | [@docutracker/embed-angular](https://www.npmjs.com/package/@docutracker/embed-angular) |
...
1. **Navigate to your team's templates within Docutracker**

![Team Templates](/embedding/team-templates.png)

2. **Click on the direct link template you want to embed**

This will copy the URL to your clipboard, e.g. `https://stg-app.docutracker.com/d/-WoSwWVT-fYOERS2MI37k`
...
```jsx
import { EmbedDirectTemplate } from '@docutracker/embed-react';
...
So `https://stg-app.docutracker.com/sign/lm7Tp2_yhvFfzdeJQzYQF` will become `lm7Tp2_yhvFfzdeJQzYQF`

2. Provide the token to the `EmbedSignDocument` component in your frameworks SDK

```jsx
import { EmbedSignDocument } from '@docutracker/embed-react';
...
In addition to embedding signing experiences, Docutracker now supports **embedded authoring**, allowing your users to create documents and templates directly within your application.
