...
In addition to embedding signing experiences, Docutracker now supports embedded authoring, allowing you to integrate document and template creation and editing directly within your application.
...
```jsx
import { EmbedCreateDocumentV1 } from '@docutracker/embed-react';
...
```jsx
import { EmbedCreateTemplateV1 } from '@docutracker/embed-react';
...
```jsx
import { EmbedUpdateDocumentV1 } from '@docutracker/embed-react';
...
```jsx
import { EmbedUpdateTemplateV1 } from '@docutracker/embed-react';
...
This API endpoint requires authentication with your Docutracker API key. The token has a default expiration of 1 hour, but you can customize this duration based on your security requirements.

You can find more details on this request at our [API Documentation](https://openapi.docutracker.com/reference#tag/embedding)
...
| `host`             | string  | Optional custom host URL. Defaults to `https://app.docutracker.com`.       |
...
import { EmbedCreateDocumentV1, EmbedUpdateDocumentV1 } from '@docutracker/embed-react';
