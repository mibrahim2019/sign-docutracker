...
description: Learn how to set up OAuth providers for your own instance of Docutracker.
---
...
9. Set the authorized javascript origins to `https://<docutracker-domain>`
10. Set the authorized redirect URIs to `https://<docutracker-domain>/api/auth/callback/google`
11. In the Docutracker environment variables, set the following:
...
5. Enter a name for your application (e.g., "Docutracker")
...
7. Under **Redirect URI**, select **Web** and enter: `https://<docutracker-domain>/api/auth/callback/microsoft`
8. Click **Register**
...
7. In the Docutracker environment variables, set the following:
