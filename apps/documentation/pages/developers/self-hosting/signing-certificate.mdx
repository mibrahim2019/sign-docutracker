...
description: Learn how to generate or buy a signing certificate for your Docutracker instance.
---
...
Self-hosting your Docutracker instance requires your own certificate to sign documents. [This article](https://docutracker.com/blog/building-docutracker-pt1) explains why.
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the Docutracker config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure Docutracker to use the certificate
