...
The guide assumes you have a Docutracker account. If you don't, you can create a free account [here](https://documen.so/free-docs).

### Upload Document

Navigate to the [Docutracker dashboard](https://app.docutracker.com/documents) and click on the "Upload Document" button located at the top right of the page. Select the documents you want to upload and wait for the upload to complete.
...
![Docutracker dashboard](/document-signing/docutracker-documents-dashboard.webp)
...
The Docutracker editor allows you to create and configure documents or templates. The editor consists of three sections that guide you through the process of preparing your document.
...
![Editor page in the Docutracker dashboard](/document-signing/editor-overview.webp)
...
![Upload and add recipients page in the Docutracker editor](/document-signing/editor-upload-recipients.webp)
...
Docutracker has 5 roles for recipients with different permissions and actions.
...
Docutracker supports 10 different field types that can be added to the document. Each field type collects various information from the recipients when they sign the document.
...
![The available field types in the Docutracker dashboard](/document-signing/docutracker-document-fields.webp)
...
![Preview section in the Docutracker editor](/document-signing/docutracker-editor-preview.webp)

### Email Settings

Before sending the document, you can configure the email settings and customize the subject line, message, and sender name.

![Email settings in the Docutracker dashboard](/document-signing/docutracker-document-email-settings.webp)

If you leave the email subject and message empty, Docutracker will use the default email template.
...
![The email sent to the recipients with the signing link](/document-signing/docutracker-sign-email.webp)
...
![How to copy the signing link for each recipient from the Docutracker dashboard](/document-signing/docutracker-signing-links.webp)

The signing link has the following format:

```bash
https://app.docutracker.com/sign/12ACP777zxQLO52hjj_vCB
```
...
![General Docutracker editor settings](/document-signing/docutracker-editor-general-settings.webp)
...
![Email Docutracker editor settings](/document-signing/docutracker-editor-email-settings.webp)
...
Docutracker enables you to set up access control for your documents. You can require authentication for viewing the document.
...
![Security Docutracker editor settings](/document-signing/docutracker-editor-security-settings.webp)
