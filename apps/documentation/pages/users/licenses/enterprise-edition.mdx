...
description: Learn about the Enterprise Edition of Docutracker.
---
...
The Docutracker Enterprise Edition is our license for self-hosters that need the full range of support and compliance.
...
- Permission to self-Host Docutracker in any context.
...
1. Access your license key at [license.docutracker.com](https://license.docutracker.com)
2. Set the `NEXT_PRIVATE_DOCUMENSO_LICENSE_KEY` environment variable in your Docutracker instance with your license key
