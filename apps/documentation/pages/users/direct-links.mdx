...
![Template page in the Docutracker dashboard](/direct-links/document-direct-link-docutracker.webp)
...
![Enable the document direct link in the Docutracker dashboard](/direct-links/enable-document-direct-link-modal.webp)
...
![Choose the Direct Link recipient](/direct-links/choose-direct-link-recipient-docutracker.webp)
...
```bash
https://app.docutracker.com/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [Docutracker profile](/users/profile) to make them signable anytime.

![Choose the Direct Link recipient](/direct-links/docutracker-profile.webp)
