---
title: Templates
description: Learn how to create and use templates in Docutracker.
---
...
Docutracker allows you to create templates, which are reusable documents. Templates are helpful if you often send the same type of document, such as contracts, agreements, or invoices, as they help you save time.
...
![Docutracker template page](/templates/docutracker-template-page.webp)
...
![A successfully uploaded document in the Docutracker dashboard](/templates/docutracker-template-page-uploaded-document.webp)
...
- placeholder@docutracker.com
- me@docutracker.com

![Adding placeholder recipients for the Docutracker template](/templates/docutracker-template-recipients.webp)
...
![Use an available Docutracker template](/templates/docutracker-use-template.webp)
