...
description: Learn about the different standards and regulations for Docutracker.
---
...
> Read more about 21 CFR Part 11 with Docutracker here: https://documen.so/21-CFR-Part-11
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/docutracker/backlog/issues/26)
</Callout>
...
<Callout type="warning" emoji="⏳">
  Status: [Planned](https://github.com/docutracker/backlog/issues/25)
</Callout>
