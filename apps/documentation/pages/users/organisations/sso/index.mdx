...
- **Single Sign-On**: Access Docutracker using your own authentication system
...
Create a custom subdomain for your organisation's SSO portal. For example, you can create a subdomain like `docutracker.your-organisation.com` which redirects to the portal link.
...
- Ensure the redirect URI in Docutracker matches exactly what's configured in your identity provider
...
2. Check the Docutracker logs for detailed error messages
