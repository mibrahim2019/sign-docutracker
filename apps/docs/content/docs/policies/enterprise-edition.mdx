...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate Docutracker into proprietary products.
---
...
- **Build proprietary products**: Integrate Docutracker into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to Docutracker source code that you don't want to disclose

<Callout type="info">
  If you run Docutracker without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using Docutracker API only        | Community Edition  |
| SaaS product with modified Docutracker code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed Docutracker in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute Docutracker as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    2. Access your license key at [license.docutracker.com](https://license.docutracker.com)
    ...
    4. Restart your Docutracker instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and Docutracker. Key terms include:

    - **Scope**: License to use, modify, and distribute Docutracker as specified in your agreement
    - **Exclusions**: The license does not grant rights to Docutracker trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - Docutracker Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or Docutracker Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@docutracker.com](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating Docutracker before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access Docutracker Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include Docutracker Cloud?">
