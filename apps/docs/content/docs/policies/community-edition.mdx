...
description: The open-source version of Docutracker, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
The full license text is available in the [LICENSE file](https://github.com/docutracker/docutracker/blob/main/LICENSE) in the repository.
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run Docutracker for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify Docutracker and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      Docutracker instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate Docutracker code are subject to AGPL-3.0
...
The Community Edition includes the core Docutracker functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The Docutracker Discord server is the primary community support channel. You can:
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/docutracker/docutracker/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/docutracker/docutracker/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and Docutracker team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to Docutracker are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [Docutracker repository](https://github.com/docutracker/docutracker)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/docutracker/docutracker/blob/main/CONTRIBUTING.md) file in the repository
