...
Join the Docutracker Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other Docutracker users
...
- **[GitHub Discussions](https://github.com/docutracker/docutracker/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/docutracker/docutracker/issues)**: Report confirmed bugs with reproducible steps

When opening an issue, include:

1. Docutracker version
...
Paid plans include access to direct support from the Docutracker team.
...
- Email support at support@docutracker.com
- Account and billing assistance
- Technical guidance for Docutracker Cloud usage
...
- Private Discord channel for direct communication with the Docutracker team
...
- [GitHub Discussions](https://github.com/docutracker/docutracker/discussions) - Community Q&A
...
- Guidance on Docutracker features and functionality
...
For billing disputes or account issues, email support@docutracker.com with your account details.
...
<Steps>
  <Step>
    ...
    Email security@docutracker.com.
...
Docutracker follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@docutracker.com                                          |
| Security issues  | security@docutracker.com                                         |
| Enterprise sales | [sales@docutracker.com](https://documen.so/enterprise)           |
| Privacy requests | privacy@docutracker.com                                          |
| Community        | [Discord](https://documen.so/discord)                          |
| Bug reports      | [GitHub Issues](https://github.com/docutracker/docutracker/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How Docutracker handles your data
