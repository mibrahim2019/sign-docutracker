---
title: Security
description: Security practices for Docutracker Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/docutracker/docutracker](https://github.com/docutracker/docutracker)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from Docutracker is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    Docutracker encrypts sensitive data at the application level:
...
Docutracker operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@docutracker.com**
...
- [GitHub releases](https://github.com/docutracker/docutracker/releases)
- [GitHub security advisories](https://github.com/docutracker/docutracker/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/docutracker/docutracker) for releases
...
When self-hosting Docutracker, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@docutracker.com
- **General questions**: support@docutracker.com
- **GitHub**: [github.com/docutracker/docutracker](https://github.com/docutracker/docutracker)
