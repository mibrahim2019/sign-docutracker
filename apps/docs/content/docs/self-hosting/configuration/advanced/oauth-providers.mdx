...
- **Authorized JavaScript origins**: `https://<docutracker-domain>`
- **Authorized redirect URIs**: `https://<docutracker-domain>/api/auth/callback/google`

</Step>
<Step>
### Set environment variables

In your Docutracker environment, set:
...
```bash
https://<docutracker-domain>/api/auth/callback/microsoft
```
