---
title: Self-Hosting
description: Deploy and manage your own Docutracker instance for complete control over your data, compliance, and customization.
---
...
Get Docutracker running locally in under 5 minutes:
...
Self-hosted Docutracker includes full core functionality under the AGPL-3.0 license. If you need enterprise features such as SSO, embed authoring white label, or 21 CFR Part 11 compliance, you can activate them with a license key.
...
<Cards>
  <Card
    title="User Guide"
    description="Learn how to use Docutracker for document signing."
    href="/docs/users"
  />
  <Card
    title="Developer Guide"
    description="Integrate Docutracker into your applications using the API."
