...
description: Sign up for Docutracker and configure your profile.
---
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@docutracker.com`.
...
<Steps>
  <Step>
    ...
    ![Docutracker account security page showing security options](/get-started-images/docutracker-account-security-page.webp)
  ...
  <Step>
    ...
    ![Dialog to enable two-factor authentication with QR code setup](/get-started-images/docutracker-enable-2-factor-authentication.webp)
  ...
  <Step>
    ...
    ![Passkeys settings page showing registered passkeys](/get-started-images/docutracker-passkeys-page.webp)
  ...
  <Step>
    ...
    ![Dialog to add a new passkey with name input field](/get-started-images/docutracker-add-passkey-box.webp)
