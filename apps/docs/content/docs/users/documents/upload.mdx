...
description: Upload documents to Docutracker to prepare them for signing. Covers supported formats, file size limits, and upload methods.
---
...
<Callout type="warn">
  Docutracker does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>

## Upload Methods

![Documents dashboard](/document-signing/docutracker-documents-dashboard.webp)
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.docutracker.com/documents).
...
1. **Processing**: Docutracker validates the PDF and extracts page information
