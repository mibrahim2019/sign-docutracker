...
- **Create one automatically**: Docutracker creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-docutracker.webp)
...
```
https://app.docutracker.com/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-docutracker.webp)
...
If the recipient has a Docutracker account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public Docutracker profile:
...
![Docutracker profile with direct links](/direct-links/docutracker-profile.webp)
...
```html
<a href="https://app.docutracker.com/d/your-token">Sign our agreement</a>
```
