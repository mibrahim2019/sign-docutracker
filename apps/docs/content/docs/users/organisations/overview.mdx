---
title: Overview
description: Organisations are the top-level entity in Docutracker, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Docutracker's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Docutracker dashboard](/organisations/organisations-create.webp)
