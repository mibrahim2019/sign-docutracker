...
In addition to embedding signing, Docutracker supports embedded authoring. It allows your users to create and edit documents and templates without leaving your application.
...
This endpoint requires your Docutracker API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.docutracker.com/reference#tag/embedding) for full details.
...
| `host`             | `string`  | No       | Custom host URL. Defaults to `https://app.docutracker.com` |
