...
Docutracker offers two types of embedding:
...
- Dark mode controls
- Removal of Docutracker branding
...
<Steps>
<Step>
Navigate to your team's templates in Docutracker
...
For example, `https://app.docutracker.com/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
<Cards>
  <Card
    title="React"
    description="@docutracker/embed-react"
    href="/docs/developers/embedding/sdks/react"
  />
  <Card title="Vue" description="@docutracker/embed-vue" href="/docs/developers/embedding/sdks/vue" />
  <Card
    title="Svelte"
    description="@docutracker/embed-svelte"
    href="/docs/developers/embedding/sdks/svelte"
  />
  <Card
    title="Angular"
    description="@docutracker/embed-angular"
    href="/docs/developers/embedding/sdks/angular"
  />
  <Card
    title="Solid"
    description="@docutracker/embed-solid"
    href="/docs/developers/embedding/sdks/solid"
  />
  <Card
    title="Preact"
    description="@docutracker/embed-preact"
    href="/docs/developers/embedding/sdks/preact"
  />
</Cards>

A [Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) SDK (`@docutracker/embed-webcomponent`) is also available for use outside of JavaScript frameworks. It works in any environment that supports custom elements.
...
| `host`                | `string`   | Docutracker instance URL. Defaults to `https://app.docutracker.com`. |
