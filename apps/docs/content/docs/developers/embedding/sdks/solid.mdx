---
title: Solid
description: Embed Docutracker signing in your Solid application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @docutracker/embed-solid ```</Tab>
  <Tab value="yarn">``` yarn add @docutracker/embed-solid ```</Tab>
  <Tab value="pnpm">``` pnpm add @docutracker/embed-solid ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@docutracker/embed-solid';
...
```tsx
import { EmbedSignDocument } from '@docutracker/embed-solid';
