---
title: Preact
description: Embed Docutracker signing in your Preact application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @docutracker/embed-preact ```</Tab>
  <Tab value="yarn">``` yarn add @docutracker/embed-preact ```</Tab>
  <Tab value="pnpm">``` pnpm add @docutracker/embed-preact ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@docutracker/embed-preact';
...
```tsx
import { EmbedSignDocument } from '@docutracker/embed-preact';
