---
title: Angular
description: Embed Docutracker signing in your Angular application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @docutracker/embed-angular ```</Tab>
  <Tab value="yarn">``` yarn add @docutracker/embed-angular ```</Tab>
  <Tab value="pnpm">``` pnpm add @docutracker/embed-angular ```</Tab>
</Tabs>
...
import { EmbedDirectTemplate } from '@docutracker/embed-angular';
...
import { EmbedSignDocument } from '@docutracker/embed-angular';
