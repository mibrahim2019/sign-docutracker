...
description: Create and send a document for signing using the Docutracker API, from uploading a PDF to adding recipients and distributing for signature.
---
...
- A Docutracker account (cloud or self-hosted)
...
| ----------- | -------------------------------------- |
| Production  | `https://app.docutracker.com/api/v2`     |
| Staging     | `https://stg-app.docutracker.com/api/v2` |
...
```javascript
const response = await fetch('https://app.docutracker.com/api/v2/envelope', {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://app.docutracker.com/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://app.docutracker.com/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://app.docutracker.com/api/v2"
...
- [API Reference](https://openapi.docutracker.com/) - Full endpoint documentation with request/response schemas
...
- [TypeScript SDK](https://github.com/docutracker/sdk-typescript)
- [Python SDK](https://github.com/docutracker/sdk-python)
- [Go SDK](https://github.com/docutracker/sdk-go)
