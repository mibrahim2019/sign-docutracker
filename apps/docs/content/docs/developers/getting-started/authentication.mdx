...
- A Docutracker account on any plan (Free, Individual, Team, or Enterprise)
...
- Log in to your Docutracker account
- Click your avatar in the top right corner
- Select **Settings** from the dropdown menu

![User dropdown menu](/public-api-images/docutracker-user-dropdown-menu.webp)
...
![API tokens page](/public-api-images/api-tokens-page-docutracker.webp)
...
![API key display](/public-api-images/docutracker-api-key-blurred.webp)
...
```bash
curl https://app.docutracker.com/api/v2/documents \
...
```typescript
const response = await fetch('https://app.docutracker.com/api/v2/documents', {
  method: 'GET',
  headers: {
...
Docutracker provides official SDKs that handle authentication for you:

```typescript
import { Docutracker } from '@docutracker/sdk-typescript';

const client = new Docutracker({
...
SDKs are available for [TypeScript](https://github.com/docutracker/sdk-typescript), [Python](https://github.com/docutracker/sdk-python), and [Go](https://github.com/docutracker/sdk-go).
...
<Callout type="info">
  ...
  OpenAPI reference](https://app.docutracker.com/api/v1/openapi).
</Callout>
