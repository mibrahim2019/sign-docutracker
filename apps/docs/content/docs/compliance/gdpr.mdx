---
title: GDPR
description: Understand how Docutracker handles GDPR compliance for data processing and storage.
---
...
When using Docutracker for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using Docutracker) determine the purposes and means of processing |
| **Data Processor**  | Docutracker processes personal data on your behalf according to your instructions       |
...
As the data processor, Docutracker:
...
Docutracker processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use Docutracker:

<Tabs items={['Docutracker Cloud', 'Self-Hosted']}>
<Tab value="Docutracker Cloud">
...
Contact Docutracker for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host Docutracker:

- You control all data storage locations
- No data is transmitted to Docutracker's infrastructure
...
- Export user and document data from your Docutracker account
- Delete user accounts and associated documents
- Contact Docutracker support for assistance with cloud-hosted data

## Data Deletion

Docutracker supports data deletion to help fulfill erasure requests:
...
Self-hosting Docutracker can simplify GDPR compliance:
...
- Contact [support@docutracker.com](mailto:support@docutracker.com) to request a DPA
- The DPA covers Docutracker's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with Docutracker is required since no personal data is processed by Docutracker.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use Docutracker, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy Docutracker on your own infrastructure
