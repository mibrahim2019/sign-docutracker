...
<Callout type="info">
  Docutracker seals all signed documents cryptographically, regardless of signature level, to prevent
...
## What Docutracker Provides

Docutracker supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What Docutracker Does Not Provide
...
<Callout type="warn">Status: [Planned](https://github.com/docutracker/backlog/issues/34)</Callout>
