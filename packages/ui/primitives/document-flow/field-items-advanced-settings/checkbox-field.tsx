...
import { validateCheckboxField } from '@docutracker/lib/advanced-fields-validation/validate-checkbox';
import { type TCheckboxFieldMeta as CheckboxFieldMeta } from '@docutracker/lib/types/field-meta';
        ...
        <div>
          {values.map((value, index) => (
            <div key={index} className="mt-2 flex items-center gap-4">
              ...
              <button
                type="button"
                className="col-span-1 mt-auto inline-flex h-10 w-10 items-center text-foreground/80 hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50"
