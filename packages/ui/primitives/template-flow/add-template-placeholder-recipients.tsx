                          ...
                          >
                            ...
                            >
                              ...
                              <div className="col-span-2 flex gap-x-2">
                                ...
                                {isSignerDirectRecipient(signer) ? (
                                  <Tooltip>
                                    <TooltipTrigger className="col-span-1 mt-auto inline-flex h-10 w-10 items-center justify-center text-foreground/80 hover:opacity-80">
                                  ...
                                  <button
                                    type="button"
                                    className="col-span-1 mt-auto inline-flex h-10 w-10 items-center justify-center text-foreground/80 hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50"
