      ...
      >
        <CardContent className="flex flex-col items-center justify-center p-6 text-muted-foreground/40">
          {disabled ? (
            ...
            <div className="flex">
              <motion.div
                className="group-hover:bg-destructive/2 a z-10 flex aspect-[3/4] w-24 origin-top-right -rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-destructive/10"
              ...
              <motion.div
                className="z-20 flex aspect-[3/4] w-24 flex-col items-center justify-center gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-destructive/50 group-hover:bg-destructive/5"
              ...
              <motion.div
                className="group-hover:bg-destructive/2 z-10 flex aspect-[3/4] w-24 origin-top-left rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-destructive/10"
            ...
            <div className="flex">
              <motion.div
                className="a z-10 flex aspect-[3/4] w-24 origin-top-right -rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-documenso/80"
              ...
              <motion.div
                className="z-20 flex aspect-[3/4] w-24 flex-col items-center justify-center gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-documenso/80"
              ...
              <motion.div
                className="z-10 flex aspect-[3/4] w-24 origin-top-left rotate-[22deg] flex-col gap-y-1 rounded-lg border border-muted-foreground/20 bg-muted/80 px-2 py-4 backdrop-blur-sm group-hover:border-documenso/80"
